...
texture_properties_t texture_properties[] = {
    ...
    { &qpal_alpha,            QPIC_ALPHA_OP_EDGE_FIX,      true,  true,  false, false }, // ALIAS_SKIN_HOLEY
    { &qpal_alpha_fullbright, QPIC_ALPHA_OP_EDGE_FIX,      true,  true,  false, false }, // ALIAS_SKIN_HOLEY_FULLBRIGHT
